  ...
  for( icall=0; icall<nicall; icall++ ) {
    ...
    for( jcall=0; jcall<njcall; jcall++ ) {
      ...
      for( i=ista; i<=iend; i++ ) {
        ...
        gxd[i] += 0.375/pi*gxi[i]*(yi[i]*zmd[nmd][0]-zi[i]*ymd[nmd][0]-xmd[nmd][0]);
        gyd[i] += 0.375/pi*gxi[i]*(yi[i]*zmd[nmd][1]-zi[i]*ymd[nmd][1]-xmd[nmd][1]);
        gzd[i] += 0.375/pi*gxi[i]*(yi[i]*zmd[nmd][2]-zi[i]*ymd[nmd][2]-xmd[nmd][2]);
      }
      ...
      for( i=ista; i<=iend; i++ ) {
        ...
        gxd[i] += 0.375/pi*gyi[i]*(zi[i]*xmd[nmd][0]-xi[i]*zmd[nmd][0]-ymd[nmd][0]);
        gyd[i] += 0.375/pi*gyi[i]*(zi[i]*xmd[nmd][1]-xi[i]*zmd[nmd][1]-ymd[nmd][1]);
        gzd[i] += 0.375/pi*gyi[i]*(zi[i]*xmd[nmd][2]-xi[i]*zmd[nmd][2]-ymd[nmd][2]);
      }
      ...
      for( i=ista; i<=iend; i++ ) {
        ...
        gxd[i] += 0.375/pi*gzi[i]*(xi[i]*ymd[nmd][0]-yi[i]*xmd[nmd][0]-zmd[nmd][0]);
        gyd[i] += 0.375/pi*gzi[i]*(xi[i]*ymd[nmd][1]-yi[i]*xmd[nmd][1]-zmd[nmd][1]);
        gzd[i] += 0.375/pi*gzi[i]*(xi[i]*ymd[nmd][2]-yi[i]*xmd[nmd][2]-zmd[nmd][2]);
      }
