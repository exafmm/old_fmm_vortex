...
void ifbox(int n0, int n1, int& mjp, int nmp, int lbi, int lbj, int& lbjr, int& lbjrp, int lev, int ipb, int npb, double* tfmm) {
  int nnmax,nmmax,ii,i,j,nr,ic,jj,np;
  double tic,toc,rb;
